...
all: ntrip_client_exam ntrip_caster_exam ntrip_server_exam neptune_base neptune_rover
...
neptune_base: src/neptune_base.o \
	src/ntrip_caster.o \
	src/ntrip_server.o \
	src/ntrip_util.o
	$(CC)g++ $^ ${LDFLAGS} -o $@

neptune_rover: src/neptune_rover.o \
	src/ntrip_client.o \
	src/ntrip_util.o
	$(CC)g++ $^ ${LDFLAGS} -o $@
